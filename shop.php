            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        ...
                        <h2>¡CONOCE NUESTRA TIENDA FÍSICA!</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        ...
                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="single-product.html">Añadir al carrito</a>
                        </div>                       
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
